...
def test_update_global_analytics_aggregation():
    ...
    LeaderboardEntry.objects.create(country="US", state="MI", mastery_score=1000, player_level=5)
    LeaderboardEntry.objects.create(country="US", state="MI", mastery_score=2000, player_level=6)
    LeaderboardEntry.objects.create(country="US", state="MI", mastery_score=3000, player_level=4)
    
    # Create 1 session in Canada
    LeaderboardEntry.objects.create(country="CA", state="ON", mastery_score=5000, player_level=10)
...
def test_api_sanitizes_profanity(client):
    ...
    payload = {
        ...
        "determination_score": 10, "mastery_score": 20, "player_level": 1,
        "session_duration_seconds": 60, "total_questions_answered": 10,
        "session_accuracy_percent": 100, "levels_gained": 0, "mastery_gained": 20,
        "determination_gained": 10
    }
